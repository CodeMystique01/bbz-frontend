    ...
    return (
        <div style={{ maxWidth: 640 }}>
            ...
            <div style={{ marginBottom: 32 }}>
                ...
                <p style={{ fontSize: 14, color: "#9ca3af", marginTop: 4, marginBottom: 0 }}>Manage your personal information</p>
            </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 28, paddingBottom: 28, borderBottom: "1px solid #f5f5f5" }}>
                    <div style={{ position: "relative" }}>
                        ...
                        <div style={{
                            ...
                            <Camera style={{ height: 11, width: 11, color: "#9ca3af" }} />
                        </div>
                    </div>
                    <div>
                        ...
                        <span style={{
                            ...
                            color: "#2563eb", background: "#eff6ff", borderRadius: 20,
