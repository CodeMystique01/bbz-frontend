...
import { User, Mail, Save, Store } from "lucide-react";
    ...
    return (
        <div className="space-y-6 animate-fade-in" style={{ maxWidth: 576 }}>
            <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Manage your store and account details</p>
            </div>
            ...
            <div className="rounded-xl border border-gray-100 p-6">
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-purple-600 mt-0.5">Vendor</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="text" value={form.name} onChange={(e) => setForm((p) => ({ ...p, name: e.target.value }))}
                                placeholder="Your store name" className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-200" />
                        </div>
                    </div>
                    <div>
